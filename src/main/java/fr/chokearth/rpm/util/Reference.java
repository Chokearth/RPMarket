...
public class Reference {
    ...
    //GUI/CONTAINER
    public static final int GUI_STAND_STORAGE = 0;
    public static final int GUI_STAND_SELL_OWNER = 1;
    public static final int GUI_STAND_SELL_BUYER = 2;
}
